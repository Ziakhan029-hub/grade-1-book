...
const TEXTS = [
  // lesson prompts + unit name
  'كوّن عشرات وآحاد', 'اقرأ المسألة ثم اختر الإجابة', 'كوّن العدد بالعشرات والآحاد',
  'قدّر العدد ثم تحقق', 'قارن بين العددين', 'رتّب الأعداد', 'القيمة المنزلية',
  'اختر الإجابة',
  // tens words
  'عشرون','ثلاثون','أربعون','خمسون','ستون','سبعون','ثمانون','تسعون','مئة',
  // vocabulary + compare
  'عشرات','آحاد','أكبر','أصغر','يساوي',
  // praise
  'أحسنت','ممتاز',
  // 9-2 story lines
  '١٢ كُمَّثْرى في طَبَقَيْنِ بِالتَّساوي. كم في كُلِّ طَبَقٍ؟',
  '٣ مَجموعاتٍ، في كُلِّ مَجموعةٍ ١٠ أزرارٍ. كم زِرًّا في الكُلِّ؟',
  '١٨ بالونًا بَيْنَ بِنْتَيْنِ بِالتَّساوي. كم لِكُلِّ واحِدةٍ؟',
  '٤ مَجموعاتٍ، في كُلِّ مَجموعةٍ ٥ طُلّابٍ. كم طالِبًا في الكُلِّ؟',
];
