...
// Chapter-7 subtraction apple game. ok/done/number clips are shared & already exist.
const LINES = [
  'كم تفّاحة بقيت على الشجرة؟',   // question (NARR.q)
  'الطرح'                          // unit name for the lessons-hub card 🔊
];
...
(async ()=>{
  ...
  console.log('\nmap:');
  for (const l of LINES) { console.log('  "'+l+'" -> ../../audio/'+hash(l)+'.mp3   (hub: ../audio/'+hash(l)+'.mp3)'); }
  console.log('Done.');
})();
