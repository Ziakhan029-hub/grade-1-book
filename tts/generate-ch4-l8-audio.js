...
// Chapter 4 · Lesson 8 — العدد الترتيبي (ordinal numbers) — FatimaNeural
const TEXTS = [
  'اضغط على الأرنب الأول',
  'اضغط على الأرنب الثالث',
  'اضغط على الأرنب الخامس',
  'اضغط على البطة الثانية',
  'اضغط على البطة الرابعة',
  'اضغط على البطة السابعة',
  'اضغط على الطائر السادس',
  'اضغط على السحلية الثامنة',
];
